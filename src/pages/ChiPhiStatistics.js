...
const ChiPhiStatistics = () => {
    ...
    const filteredItems = useMemo(() => {
        return getSortedItems.filter(chi => {
            ...
            const matchesYear = filterYear === 'TẤT CẢ' || chiYear === filterYear;
                ...
                return {
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: `Thống kê chi tiêu theo ${getGroupLabel(groupBy)} (Năm ${filterYear})`,
                                font: {
                                    size: 16
                                }
                            }
                ...
                return {
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: `Phân bổ chi tiêu theo ${getGroupLabel(groupBy)} (Năm ${filterYear})`,
                                font: {
                                    size: 16
                                }
                            }
...
/>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                            ...
                            <p className="text-xs text-blue-600 mt-1">Thời gian: {startDate && endDate ? `${formatDate(startDate)} - ${formatDate(endDate)}` : `Năm ${filterYear}`}</p>
                        </div>
